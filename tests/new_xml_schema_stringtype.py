...
schema_order_person_info_bill_to = StructType(
    [
        ...
        StructField("_Latitude", StringType(), True),
        StructField("_Lockid", StringType(), True),
        StructField("_Longitude", StringType(), True),
        StructField("_MiddleName", StringType(), True),
        StructField("_MobilePhone", StringType(), True),
...
schema_order_remaining_totals = StructType(
    [
        StructField("_GrandCharges", StringType(), True),
        StructField("_GrandDiscount", StringType(), True),
        StructField("_GrandTax", StringType(), True),
        StructField("_GrandTotal", StringType(), True),
        StructField("_HdrCharges", StringType(), True),
        StructField("_HdrDiscount", StringType(), True),
        StructField("_HdrTax", StringType(), True),
        StructField("_HdrTotal", StringType(), True),
        StructField("_LineSubTotal", StringType(), True),
        StructField("_VALUE", StringType(), True),
    ]
)
...
schema_customer_additional_address = StructType(
    [
        ...
        StructField("_CustomerAdditionalAddressKey", StringType(), True),
        StructField("_CustomerContactKey", StringType(), True),
        StructField("_CustomerKey", StringType(), True),
...
schema_order_customer = StructType(
    [
        ...
        StructField("_CustomerType", StringType(), True),
...
schema_order_additional_addresses = StructType(
    [
        StructField("_NumberOfAdditionalAddresses", StringType(), True),
        StructField("_VALUE", StringType(), True),
    ]
)
...
schema_credit_card_transaction = StructType(
    [
        StructField("_AuthAmount", StringType(), True),
        ...
        StructField("_AuthTime", StringType(), True),
        StructField("_ChargeTransactionKey", StringType(), True),
        StructField("_CreditCardTransactionKey", StringType(), True),
        ...
        StructField("_TranAmount", StringType(), True),
        StructField("_TranRequestTime", StringType(), True),
...
schema_charge_transaction_detail = StructType(
    [
        ...
        StructField("_BookAmount", StringType(), True),
        StructField("_ChargeTransactionKey", StringType(), True),
        StructField("_ChargeType", StringType(), True),
        StructField("_CollectionDate", StringType(), True),
        StructField("_CreditAmount", StringType(), True),
        StructField("_DebitAmount", StringType(), True),
        StructField("_DistributedAmount", StringType(), True),
        StructField("_HoldAgainstBook", StringType(), True),
        StructField("_OpenAuthorizedAmount", StringType(), True),
        StructField("_OrderHeaderKey", StringType(), True),
        StructField("_OrderInvoiceKey", StringType(), True),
        StructField("_PaymentKey", StringType(), True),
        StructField("_RequestAmount", StringType(), True),
        StructField("_SettledAmount", StringType(), True),
        StructField("_Status", StringType(), True),
        StructField("_TransactionDate", StringType(), True),
...
schema_order_charge_transaction_details = StructType(
    [
        ...
        StructField("_AdditionalExpectedAuthorizations", StringType(), True),
        StructField("_TotalCredits", StringType(), True),
        StructField("_TotalDebits", StringType(), True),
        StructField("_TotalOpenAuthorizations", StringType(), True),
        StructField("_TotalOpenBookings", StringType(), True),
        StructField("_TotalTransferredIn", StringType(), True),
        StructField("_TotalTransferredOut", StringType(), True),
    ]
)
...
schema_item = StructType(
    [
        ...
        StructField("_UnitCost", StringType(), True),
...
schema_item_details_primary_information = StructType(
    [
        ...
        StructField("_UnitHeight", StringType(), True),
        StructField("_UnitLength", StringType(), True),
        StructField("_UnitWeight", StringType(), True),
        StructField("_UnitWidth", StringType(), True),
        StructField("_VALUE", StringType(), True),
    ]
)
...
schema_item_details = StructType(
    [
        ...
        StructField("_ItemID", StringType(), True),
        StructField("_ItemKey", StringType(), True),
        StructField("_Lockid", StringType(), True),
        StructField("_MaxModifyTS", StringType(), True),
        StructField("_Modifyprogid", StringType(), True),
        StructField("_Modifyts", StringType(), True),
        StructField("_Modifyuserid", StringType(), True),
...
schema_kit_lines = StructType(
    [
        StructField("_NumberOfKitLines", StringType(), True),
        StructField("_VALUE", StringType(), True),
    ]
)
...
schema_charge_category_details = StructType(
    [
        StructField("_ChargeCategoryKey", StringType(), True),
...
schema_line_charge = StructType(
    [
        ...
        StructField("_AmountFromAddnlLinePrices", StringType(), True),
        StructField("_ChargeAmount", StringType(), True),
        StructField("_ChargeCategory", StringType(), True),
        StructField("_ChargeName", StringType(), True),
        StructField("_ChargeNameKey", StringType(), True),
        StructField("_ChargePerLine", StringType(), True),
        StructField("_ChargePerUnit", StringType(), True),
        StructField("_InvoicedChargeAmount", StringType(), True),
        StructField("_InvoicedChargePerLine", StringType(), True),
        StructField("_InvoicedChargePerUnit", StringType(), True),
        StructField("_IsBillable", StringType(), True),
        StructField("_IsDiscount", StringType(), True),
        ...
        StructField("_Reference", StringType(), True),
        StructField("_RemainingChargeAmount", StringType(), True),
        StructField("_RemainingChargePerLine", StringType(), True),
        StructField("_RemainingChargePerUnit", StringType(), True),
    ]
)

schema_line_invoiced_totals = StructType(
    [
        StructField("_AdditionalLinePriceTotal", StringType(), True),
        StructField("_Charges", StringType(), True),
        StructField("_Discount", StringType(), True),
        StructField("_ExtendedPrice", StringType(), True),
        StructField("_LineTotal", StringType(), True),
        StructField("_OptionPrice", StringType(), True),
        StructField("_PricingQty", StringType(), True),
        StructField("_Tax", StringType(), True),
        StructField("_UnitPrice", StringType(), True),
        StructField("_VALUE", StringType(), True),
    ]
)
...
schema_line_price_info = StructType(
    [
        ...
        StructField("_DisplayUnitPrice", StringType(), True),
        ...
        StructField("_LineTotal", StringType(), True),
        StructField("_ListPrice", StringType(), True),
...
schema_line_tax = StructType(
    [
        ...
        StructField("_ChargeName", StringType(), True),
        StructField("_ChargeNameKey", StringType(), True),
        StructField("_InvoicedTax", StringType(), True),
        StructField("_Reference1", StringType(), True),
        StructField("_Reference2", StringType(), True),
        StructField("_Reference3", StringType(), True),
        StructField("_RemainingTax", StringType(), True),
        StructField("_Tax", StringType(), True),
        StructField("_TaxName", StringType(), True),
        StructField("_TaxPercentage", StringType(), True),
        StructField("_VALUE", StringType(), True),
    ]
)
...
schema_order_status_tran_quantity = StructType(
    [
        StructField("_StatusQty", StringType(), True),
        StructField("_TotalQuantity", StringType(), True),
...
schema_order_status = StructType(
    [
        ...
        StructField("_OrderReleaseStatusKey", StringType(), True),
        StructField("_PipelineKey", StringType(), True),
        StructField("_ShipNode", StringType(), True),
        StructField("_Status", StringType(), True),
        StructField("_StatusDate", StringType(), True),
...
schema_event_details = StructType(
    [
        ...
        StructField("_EntityVersion", StringType(), True),
        ...
        StructField("_EventTime", StringType(), True),
        ...
        StructField("_OrderNumber", StringType(), True),
...
schema_sc_status_changes_order_line = StructType(
    [
        StructField("_NewStatus", StringType(), True),
        StructField("_NewStatusDate", StringType(), True),
        StructField("_OldStatus", StringType(), True),
        StructField("_OldStatusDate", StringType(), True),
        StructField("_PrimeLineNo", StringType(), True),
        StructField("_Quantity", StringType(), True),
        StructField("_SubLineNo", StringType(), True),
        StructField("_VALUE", StringType(), True),
...
schema_sc_refund_status = StructType(
    [
        ...
        StructField("Statusts", StringType(), True),
    ]
)
